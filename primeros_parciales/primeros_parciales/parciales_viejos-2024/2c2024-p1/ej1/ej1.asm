...
indice_a_inventario:
	...
	mov r8, rbx
	shl r8, 3 ; i * tamaño del dato de item_t**
	add r8, rax ; &resultado[i]

	mov r9, rbx
	shl r9, 1 ; i * 2 (16 bits)
	add r9, r13 ; &indice[i]
	movzx r9, word [r9] ; indice[i]
	; importante porque tengo que leer solo 2 bytes, no 8
	shl r9, 3 ; indice[i] * 8
	add r9, r12 ; &inventario[indice[i]]
	mov r9, [r9] ; inventario[indice[i]]

	mov [r8], r9 ; resultado[i] = inventario[indice[i]]
